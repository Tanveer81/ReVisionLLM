...
from revisionllm.constants import IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_TOKEN
...
def parse_args():
    ...
    parser.add_argument("--pretrain_mm_mlp_adapter", type=str, default=os.path.join(root_dir, "checkpoints/revisionllm-vicuna-v1-5-7b-stage1/mm_projector.bin"))
    parser.add_argument("--stage2", type=str, default=os.path.join(root_dir, "checkpoints/revisionllm-vicuna-v1-5-7b-stage2"))
    parser.add_argument("--stage3", type=str, default=os.path.join(root_dir, "checkpoints/revisionllm-vicuna-v1-5-7b-stage3"))
