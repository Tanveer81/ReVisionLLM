...
from transformers.generation import SampleDecoderOnlyOutput, SampleEncoderDecoderOutput, validate_stopping_criteria
...
class VTimeLLMLlamaForCausalLM(LlamaForCausalLM, VTimeLLMMetaForCausalLM):
    ...
    def forward(
        ...
        visual_memory: Optional[torch.FloatTensor] = None,
        prefix_memory: Optional[str] = None,
        ...
        if inputs_embeds is None:
            (
                ...
                past_key_values,
                labels,
                # if debug in cpu we need float32
                images.to(torch.float32) if self.device.type=='cpu' else images,
    ...
    def prepare_inputs_for_generation(self, input_ids, past_key_values=None, inputs_embeds=None, **kwargs):
        ...
        if visual_memory is not None:
            _inputs['visual_memory'] = visual_memory
        if prefix_memory is not None:
            _inputs['prefix_memory'] = prefix_memory
        return _inputs
        ...
        **model_kwargs,
        ...
        while True:
            ...
            if return_dict_in_generate:
                if output_scores:
                    scores += (outputs.logits[:, -1, :],)#(next_token_scores,)
