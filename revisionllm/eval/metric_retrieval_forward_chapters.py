...
if __name__ == "__main__":
    ...
    parser.add_argument("--grounding_path", type=str, default='/checkpoints/chapters_stage1_dense')
    parser.add_argument("--retrieval_path", type=str, default='/checkpoints/chapters_stage2_long_100')
    parser.add_argument("--retrieval_path2", type=str,default=None)
